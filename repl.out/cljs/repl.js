...
}catch (e4202){if(cljsrepl.core.instance_QMARK_.call(null,Error,e4202))
{var e = e4202;
...
cljsrepl.repl.print_error = (function print_error(p__4204){
var map__4206 = p__4204;
var map__4206__$1 = ((cljsrepl.core.seq_QMARK_.call(null,map__4206))?cljsrepl.core.apply.call(null,cljsrepl.core.hash_map,map__4206):map__4206);
var line_number = cljsrepl.core._lookup.call(null,map__4206__$1,"\uFDD0'line-number",null);
var error = cljsrepl.core._lookup.call(null,map__4206__$1,"\uFDD0'error",null);
...
{var _STAR_out_STAR_4211 = cljsrepl.core._STAR_out_STAR_;
try{cljsrepl.core._STAR_out_STAR_ = cljsrepl.core._STAR_err_STAR_;
return cljsrepl.repl.print_error.call(null,evaluated);
}finally {cljsrepl.core._STAR_out_STAR_ = _STAR_out_STAR_4211;
}} else
{try{var _STAR_out_STAR_4214 = cljsrepl.core._STAR_out_STAR_;
...
}finally {cljsrepl.core._STAR_out_STAR_ = _STAR_out_STAR_4214;
}}catch (e4212){if(cljsrepl.core.instance_QMARK_.call(null,Error,e4212))
{var e = e4212;
var _STAR_out_STAR_4213 = cljsrepl.core._STAR_out_STAR_;
try{cljsrepl.core._STAR_out_STAR_ = cljsrepl.core._STAR_err_STAR_;
return cljsrepl.core.println.call(null,cljsrepl.repl.err);
}finally {cljsrepl.core._STAR_out_STAR_ = _STAR_out_STAR_4213;
}} else
{if("\uFDD0'else")
{throw e4212;
} else
...
return true;
}catch (e4216){if(cljsrepl.core.instance_QMARK_.call(null,Error,e4216))
{var e = e4216;
...
var m = cljsrepl.core.seq(arglist__4218);;
return G__4217__delegate(m);
});
G__4217.cljs$lang$arity$variadic = G__4217__delegate;
return G__4217;
})()
,cljsrepl.core.hash_map("\uFDD0'defs",cljsrepl.core.hash_map((new cljsrepl.core.Symbol(null,"evaluate-code")),cljsrepl.core.hash_map("\uFDD0'arglists",cljsrepl.core.list((new cljsrepl.core.Symbol(null,"quote")),cljsrepl.core.list(cljsrepl.core.vec([(new cljsrepl.core.Symbol(null,"text"))]))),"\uFDD0'method-params",cljsrepl.core.list(cljsrepl.core.vec([cljsrepl.core.hash_map("\uFDD0'name",(new cljsrepl.core.Symbol(null,"text")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/evaluate-code")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'doc","Evaluates some text from REPL input. If multiple forms are\n   present, evaluates in sequence until one throws an error\n   or the last form is reached. The result from the last\n   evaluated form is returned. *1, *2, *3, and *e are updated\n   appropriately.","\uFDD0'line",30,"\uFDD0'fn-var",true,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs"),(new cljsrepl.core.Symbol(null,"evaluate-next-form")),cljsrepl.core.hash_map("\uFDD0'arglists",cljsrepl.core.list((new cljsrepl.core.Symbol(null,"quote")),cljsrepl.core.list(cljsrepl.core.vec([(new cljsrepl.core.Symbol(null,"rdr"))]))),"\uFDD0'method-params",cljsrepl.core.list(cljsrepl.core.vec([cljsrepl.core.hash_map("\uFDD0'name",(new cljsrepl.core.Symbol(null,"rdr")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/evaluate-next-form")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'doc","Evaluates next clojure form in reader. Returns a map, containing\n   either resulting value and emitted javascript, or an error\n   object, or {:finished true}.","\uFDD0'line",10,"\uFDD0'fn-var",true,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs"),(new cljsrepl.core.Symbol(null,"/")),cljsrepl.core.hash_map("\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.core//"))),(new cljsrepl.core.Symbol(null,"init")),cljsrepl.core.hash_map("\uFDD0'arglists",cljsrepl.core.list((new cljsrepl.core.Symbol(null,"quote")),cljsrepl.core.list(cljsrepl.core.vec([]))),"\uFDD0'method-params",cljsrepl.core.list(cljsrepl.core.vec([])),"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/init")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",0,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",69,"\uFDD0'fn-var",true,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs"),(new cljsrepl.core.Symbol(null,"*debug*")),cljsrepl.core.hash_map("\uFDD0'line",6,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs","\uFDD0'dynamic",true,"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/*debug*"))),(new cljsrepl.core.Symbol(null,"eval-print")),cljsrepl.core.hash_map("\uFDD0'arglists",cljsrepl.core.list((new cljsrepl.core.Symbol(null,"quote")),cljsrepl.core.list(cljsrepl.core.vec([(new cljsrepl.core.Symbol(null,"input"))]))),"\uFDD0'method-params",cljsrepl.core.list(cljsrepl.core.vec([cljsrepl.core.hash_map("\uFDD0'name",(new cljsrepl.core.Symbol(null,"input")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/eval-print")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",53,"\uFDD0'fn-var",true,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs"),(new cljsrepl.core.Symbol(null,"complete-form?")),cljsrepl.core.hash_map("\uFDD0'arglists",cljsrepl.core.list((new cljsrepl.core.Symbol(null,"quote")),cljsrepl.core.list(cljsrepl.core.vec([(new cljsrepl.core.Symbol(null,"text"))]))),"\uFDD0'method-params",cljsrepl.core.list(cljsrepl.core.vec([cljsrepl.core.hash_map("\uFDD0'name",(new cljsrepl.core.Symbol(null,"text")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/complete-form?")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",62,"\uFDD0'fn-var",true,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs"),(new cljsrepl.core.Symbol(null,"prompt")),cljsrepl.core.hash_map("\uFDD0'arglists",cljsrepl.core.list((new cljsrepl.core.Symbol(null,"quote")),cljsrepl.core.list(cljsrepl.core.vec([]))),"\uFDD0'method-params",cljsrepl.core.list(cljsrepl.core.vec([])),"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/prompt")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",0,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",8,"\uFDD0'fn-var",true,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs"),(new cljsrepl.core.Symbol(null,"print-error")),cljsrepl.core.hash_map("\uFDD0'arglists",cljsrepl.core.list((new cljsrepl.core.Symbol(null,"quote")),cljsrepl.core.list(cljsrepl.core.vec([cljsrepl.core.hash_map("\uFDD0'keys",cljsrepl.core.vec([(new cljsrepl.core.Symbol(null,"error")),(new cljsrepl.core.Symbol(null,"line-number"))]))]))),"\uFDD0'method-params",cljsrepl.core.list(cljsrepl.core.vec([cljsrepl.core.hash_map("\uFDD0'name",(new cljsrepl.core.Symbol(null,"p__4204")),"\uFDD0'tag",null,"\uFDD0'shadow",null)])),"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl/print-error")),"\uFDD0'protocol-impl",null,"\uFDD0'max-fixed-arity",1,"\uFDD0'protocol-inline",null,"\uFDD0'variadic",false,"\uFDD0'line",50,"\uFDD0'fn-var",true,"\uFDD0'file","/Users/atonaal/Dev/github/reference/clojurescript-in-clojurescript/src/cljs/cljs/repl.cljs")),"\uFDD0'imports",null,"\uFDD0'uses-macros",null,"\uFDD0'requires",cljsrepl.core.hash_map((new cljsrepl.core.Symbol(null,"reader")),(new cljsrepl.core.Symbol(null,"cljsrepl.reader")),(new cljsrepl.core.Symbol(null,"comp")),(new cljsrepl.core.Symbol(null,"cljsrepl.compiler")),(new cljsrepl.core.Symbol(null,"ana")),(new cljsrepl.core.Symbol(null,"cljsrepl.analyzer"))),"\uFDD0'uses",null,"\uFDD0'excludes",cljsrepl.core.set([]),"\uFDD0'doc",null,"\uFDD0'name",(new cljsrepl.core.Symbol(null,"cljsrepl.repl"))),old);
}));
