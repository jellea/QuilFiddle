...
replgoog.provide('quilrepl.middleware');
replgoog.require('cljs.core');
replgoog.require('quilrepl.middlewares.navigation_3d');
replgoog.require('quilrepl.middlewares.navigation_3d');
replgoog.require('quilrepl.middlewares.fun_mode');
replgoog.require('quilrepl.middlewares.fun_mode');
/**
...
*/
quilrepl.middleware.fun_mode = (function fun_mode(options){return quilrepl.middlewares.fun_mode.fun_mode.call(null,options);
});
/**
...
*/
quilrepl.middleware.navigation_3d = (function navigation_3d(options){return quilrepl.middlewares.navigation_3d.navigation_3d.call(null,options);
});
